                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0">Lecturers</h4>

                                <div class="page-title-right">
                                    <a href="new-lecturer" class="btn btn-primary float-right">Add New</a>
                                </div>
                                    ...
                                    <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                        ...
                                        <tbody>
                                            <?php foreach ($lecturers as $i => $lecturer): ?>
                                                <tr>
                                                    <td><?php echo $i + 1 ?></td>
                                                    <td><?php echo $lecturer['lecturer_code'] ?></td>
                                                    <td><?php echo $lecturer['fullname'] ?></td>
                                                    <td><?php echo $lecturer['department'] ?></td>
                                                    <td>
                                                        <a href="lecturer-courses?id=<?php echo $lecturer['id'] ?>" class="btn btn-primary btn-sm">View Courses</a>
                                                    </td>
                                                </tr>
                                            <?php endforeach ?>
                                        </tbody>
