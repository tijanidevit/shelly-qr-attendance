<?php 
    ...
    $students = $attendance_obj->fetch_lecturer_course_attendances_students($lecturer_id,$course_id);
?>
<!doctype html>
<html lang="en">
                        ...
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                ...
                                <div class="page-title-right">
                                    <a href="generate-code?id=<?php echo $course_id ?>" class="btn btn-primary float-right">Generate Code</a>
                                </div>
                                    ...
                                    <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                        ...
                                        <tbody>
                                            <?php foreach ($students as $i => $student): 
                                                ...
                                                $std = $student_obj->fetch_student($student_id); 
                                                $attendance_count = $attendance_obj->fetch_lecturer_course_attendances_students_num($lecturer_id,$course_id,$student_id)
                                            ?>
                                                <tr>
                                                    <td><?php echo $i + 1 ?></td>
                                                    <td><?php echo $std['matric_number'] ?></td>
                                                    <td><?php echo $std['fullname'] ?></td>
                                                    <td><?php echo $attendance_count ?></td>
                                                    <td>
                                                        <a href="student-attendance?student_id=<?php echo $std['id'] ?>&course_id=<?php echo $course_id ?>" class="btn btn-primary btn-sm">View</a>
                                                    </td>
                                                </tr>
                                            <?php endforeach ?>
                                        </tbody>
