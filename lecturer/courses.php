<?php 
    ...
    $courses = $lecturer_obj->fetch_lecturer_courses($lecturer_id);
?>
<!doctype html>
<html lang="en">
                                        ...
                                        <tbody>
                                            <?php foreach ($courses as $i => $course): ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="generate-code?id=<?php echo $course['course_id'] ?>" class="btn btn-primary btn-sm">Generate Code</a>
                                                        <a href="attendance-record?id=<?php echo $course['course_id'] ?>" class="btn btn-primary btn-sm"> Attendance Record</a>
                                                    </td>
                                                </tr>
                                            <?php endforeach ?>
                                        </tbody>
